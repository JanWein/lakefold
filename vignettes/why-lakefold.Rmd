---
title: "Why lakefold? From monthly files to reliable reports"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Why lakefold? From monthly files to reliable reports}
...
![A delivery is archived, then a candidate is checked. A passing candidate becomes a new release; a failing candidate creates no release. Reports can read the latest successful release or a chosen historical one.](figures/release-flow.svg)
...
single dataset. The [worked walkthrough](getting-started.html) shows every
...
Open [Build a monthly reporting workflow, step by step](getting-started.html).
