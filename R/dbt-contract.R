...
#' a warning names them and `config.meta.tidyweave.untranslated` records them
...
tw_dbt_contract <- function(
  ...
  if (
    ...
    abort("The contract contains an invalid column schema.", "tw_dbt_invalid")
  }
