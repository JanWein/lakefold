...
#' @param contract A [contract()] defining the publication gate.
...
#' @inheritParams write_data
#' @param ... Arguments passed to [run()], such as `business_date` or
...
#' )
#' release <- tw_ingest(lake, source, contract, "orders", code_version = "v1")
#' release
